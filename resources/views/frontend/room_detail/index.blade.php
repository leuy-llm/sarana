                ...
                <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
                    ...
                    <div class="hotel-promotion  text-center shadow">
                        ...
                        <h5 class="text-muted small">From <span class=""
                                style="color: #08d1da;font-size: 25px;font-weight: 600;">$100</span> / NIGHT</h5>
                        <a href="#"
                    ...
                    <!-- Properties Near -->
                    <div class="properties-near mt-4 shadow-sm p-3">
                        <h6 class="mb-3">PROPERTIES NEAR</h6>
                        <ul class="list-unstyled">
                            <li class="d-flex align-items-center mb-3 mb-md-0 g-3">
                                <img src="https://images.pexels.com/photos/7167080/pexels-photo-7167080.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                                    alt="Ruzzini Palace Hotel" style="width: 70px; height: 60px; object-fit: cover;">
                                <div class="ms-3 px-3">
                                    <h6 class="mb-0">Ruzzini Palace Hotel</h6>
                                    {{-- <span class="text-warning">&#9733;&#9733;&#9733;&#9733;&#9733;</span> --}}
                                    <p class="mb-0 text-muted " style="font-size: 10px;">
                                        per night
                                        <span class="text-dark font-weight-bold ml-2" style="font-size: 25px;">$150</span>
                                    </p>
                                </div>
                            </li>
                            <li class="d-flex align-items-center mb-3 mb-md-0 g-3">
