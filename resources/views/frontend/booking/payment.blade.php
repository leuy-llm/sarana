        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="panel panel-default credit-card-box">
                    <div class="panel-heading display-table" style="display: flex; justify-content: space-between;align-items: center ">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <form role="form" style="padding: 20px 10px; "
                            action="{{ route('payment.process', $totalAmount) }}" method="post"
