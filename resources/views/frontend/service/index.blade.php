        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12 section-title text-center mb-5">
                    ...
                    <h3 style="margin-top: -10px">Our Awesome Services</h3>
                </div>
            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="row">
                                @foreach ($services as $service)
                                    <div class="col-md-6">
                                        <h6 class="font-weight-medium">{{ $service->title }}</h6>
                                        <p style="line-height: 1.6;text-align:l">{{ $service->description }}</p>
                                    </div>
                                @endforeach
                            </div>
                        </div>
