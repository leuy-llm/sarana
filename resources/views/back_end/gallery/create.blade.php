...
@section('content')
    @php
        $breadcrumbs = [
            ...
            ['title' => __('label.createGallery'), 'url' => route('gallerys.create')],
        ];
        $currentPageTitle = __('label.newGallery');
    @endphp
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form class="needs-validation" enctype="multipart/form-data" action="{{ url('gallerys') }}" method="POST"
                        novalidate="">
                        @csrf
                        <div class="mb-3">
