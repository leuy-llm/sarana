...
@section('content')
    <div iv class="container-fluid">
        @php
            $breadcrumbs = [['title' => __('label.meeting'), 'url' => route('meetings.index')]];
            $currentPageTitle = __('label.meetingList');
        @endphp
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        {{-- <div class="row mb-2">
                            <div class="col-sm-4">
                                <a href="{{ url('meetings/create') }}" tabindex="0" data-bs-toggle="popover"
                                    data-bs-trigger="hover" data-bs-placement="top" title="@lang('label.createNewMeeting')"
                                    class="btn btn-danger mb-2">
                                    <i class="mdi mdi-plus-circle me-1"></i> @lang('label.addMeeting')</a>
                            </div>

                        </div> --}}

                        <div class="table-responsive">
                            <table class="table table-centered table-striped dt-responsive nowrap w-100" id="meeting-datatable">
                                ...
                                <tbody>
                                    @foreach ($meetings as $data)
                                        <tr>
                                            ...
                                            <td>
                                                <form method="POST"
                                                    action="{{ route('meeting.toggleActive', $data->id) }}">
                                                    @csrf
                                                    <label class="switch">
                                            ...
                                            <td class="table-action">
                                                ...
                                                <a href="{{ url('meetings/' . $data->id . '/edit') }}" id="roomTypeEdit"
                                                    class="action-icon text-primary"> <i
                                                        class="mdi mdi-square-edit-outline"></i></a>
                                                <a href="{{ url('meetings/' . $data->id . '/delete') }}"
