...
<head>
    ...
    <title style="font-family: 'Hanuman', 'serif'!important;">{{ !empty($header_title) ? $header_title : '' }}
        @lang('label.for_hotel')</title>
    ...
    <!-- third party css -->
    <link href="{{ asset('admin_dashboard') }}/assets/css/vendor/fullcalendar.min.css" rel="stylesheet"
        type="text/css">
